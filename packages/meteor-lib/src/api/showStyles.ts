import type { ShowStyleBaseId, ShowStyleVariantId, StudioId } from '@sofie-automation/corelib/dist/dataModel/Ids.js'
import type {
	HotkeyDefinition,
	OutputLayers,
	SourceLayers,
} from '@sofie-automation/corelib/dist/dataModel/ShowStyleBase.js'
