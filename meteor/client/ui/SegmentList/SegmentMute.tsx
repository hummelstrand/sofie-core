...
import { SegmentMuteHeader } from './SegmentMuteHeader'
...
const SegmentMuteInner = React.forwardRef<HTMLDivElement, IProps>(function SegmentMute(props, ref) {
	...
	return (
		<div id={props.id} className={classNames('segment-timeline')} data-segment-id={props.segment._id} ref={combinedRef}>
			<SegmentMuteHeader
...
export const SegmentMute = React.memo(SegmentMuteInner)
